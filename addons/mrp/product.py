...
class product_template(osv.osv):
    ...
    _columns = {
        ...
        'property_group_ids': fields.many2many('mrp.property.group', 'mrp_product_property_group_rel', 'product_tmpl_id', 'property_group_id', string='Properties Groups',
                                               help="This kind of properties is used to propagate the properties own in production/procurement orders to their stock moves"),
    }
