openerp_announcement = function(instance) {
    instance.web.WebClient.include({
        ...
        _ab_location: function(dbuuid) {
            return '' //_.str.sprintf('https://services.openerp.com/openerp-enterprise/ab/css/%s.css', dbuuid);//_.str.sprintf('https://services.openerp.com/openerp-enterprise/ab/css/%s.css', dbuuid);
        },
