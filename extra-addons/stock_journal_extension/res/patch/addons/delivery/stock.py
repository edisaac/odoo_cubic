...
class stock_picking(osv.osv):
    ...
    _columns = {
        'carrier_id':fields.many2one("delivery.carrier","Carrier", states={'done':[('readonly',True)],'cancel':[('readonly',True)]}),
        'volume': fields.float('Volume', states={'done':[('readonly',True)],'cancel':[('readonly',True)]}),
        ...
        'carrier_tracking_ref': fields.char('Carrier Tracking Ref', size=32, states={'done':[('readonly',True)],'cancel':[('readonly',True)]}),
        'number_of_packages': fields.integer('Number of Packages', states={'done':[('readonly',True)],'cancel':[('readonly',True)]}),
        }
