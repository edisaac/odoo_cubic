...
class country_province(osv.osv):
    ...
    _columns = {
            ...
            'name': fields.char('Province Name', size=64, required=True, select=True),
            'code': fields.char('Province Code', size=6, required=True, select=True),
...
class country_district(osv.osv):
    ...
    _columns = {
            ...
            'name': fields.char('District Name', size=64, required=True, select=True),
            'code': fields.char('District Code', size=8, required=True, select=True),
        }
    _sql_constraints = [
